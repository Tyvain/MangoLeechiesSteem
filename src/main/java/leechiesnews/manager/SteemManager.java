...
public class SteemManager {
	...
	public static void uploadNews(News news) {
		...
		SteemJ steemJ = new SteemJ();		
			steemJ.createPost(news.cleanTitle, news.cleanText, news.cleanTags.toArray(new String[news.cleanTags.size()]));
...
//			
//			CommentOperation commentOperation = new CommentOperation(parentAccountName,parentPermlink, accountName, permlink, news.cleanText);
...
//		
//		DeleteCommentOperation deleteCommentOperation = new DeleteCommentOperation(accountName, permlink);
